...
public class ChuanrongController {
	...
	static {
		...
		stageMap.put("urgent_info_blank2", new Info("", 0));
		stageMap.put("urgent_info_2", new Info("第二层：", 0));
		stageMap.put("urgent_cdbx", new Info("拆东补西清刺", 15));
		stageMap.put("urgent_yxqc", new Info("有序清场清刺", 20));
		stageMap.put("urgent_info_blank3", new Info("", 0));
		stageMap.put("urgent_info_3", new Info("第三层：", 0));
		...
		stageMap.put("urgent_info_blank4", new Info("", 0));
		stageMap.put("urgent_info_4", new Info("第四层：", 0));
		...
		stageMap.put("urgent_info_blank5", new Info("", 0));
		stageMap.put("urgent_info_5", new Info("第五层：", 0));
		...
		stageMap.put("urgent_info_blank6", new Info("", 0));
		stageMap.put("urgent_info_6", new Info("第六层：", 0));
	...
	static {
		...
		ageMap.put("age_info_blank1", new Info("", 0, ""));
		ageMap.put("age_info_tz", new Info("天灾年代：", 0, ""));
		ageMap.put("age_tz1", new Info("天灾年代I", 5, "：清理至少2根年代之刺"));
		ageMap.put("age_tz2", new Info("天灾年代II", 10, "：清理至少3根年代之刺，饮泣之刺视为3根年代之刺"));
		ageMap.put("age_tz3", new Info("天灾年代III", 15, "：清理至少4根年代之刺，饮泣之刺视为3根年代之刺"));
		ageMap.put("age_info_blank2", new Info("", 0, ""));
		ageMap.put("age_info_jr", new Info("金融年代：", 0, "："));
		ageMap.put("age_jr1", new Info("金融年代I", 10, "：全程无漏通关"));
		ageMap.put("age_jr2", new Info("金融年代II", 20, "：持有巴别塔誓言或思绪混乱进入战斗并无漏"));
		ageMap.put("age_jr3", new Info("金融年代III", 40, "：同时持有思绪混乱和巴别塔誓言进入战斗并无漏"));
		ageMap.put("age_info_blank3", new Info("", 0, ""));
		ageMap.put("age_info_yj", new Info("拥挤年代：", 0, ""));
		ageMap.put("age_yj1", new Info("拥挤年代I", 15, "：同时部署人数小于等于3完成战斗"));
		ageMap.put("age_yj2", new Info("拥挤年代II", 25, "：同时部署人数小于等于3无漏过关"));
		ageMap.put("age_yj3", new Info("拥挤年代III", 40, "：同时部署人数小于等于2无漏过关"));
		ageMap.put("age_info_blank4", new Info("", 0, ""));
		ageMap.put("age_info_qg", new Info("奇观年代：", 0, ""));
		ageMap.put("age_qg1", new Info("奇观年代I", 10, "：未使用灵感进入战斗并胜利"));
		ageMap.put("age_qg2", new Info("奇观年代II", 15, "：未使用灵感进入战斗并全程无漏通关"));
		ageMap.put("age_qg3", new Info("奇观年代III", 40, "：未使用灵感进入战斗并全程无漏通关，且战斗包含至少一个领袖级敌人"));
		ageMap.put("age_info_blank5", new Info("", 0, ""));
		ageMap.put("age_info_kn", new Info("苦难年代：", 0, ""));
		ageMap.put("age_kn1", new Info("苦难年代I", 20, "：在药枚、筑墙、活木甲不生效的情况下完成战斗"));
		ageMap.put("age_kn2", new Info("苦难年代II", 40, "：在药枚、筑墙、活木甲不生效的情况下无漏完成战斗"));
		ageMap.put("age_kn3", new Info("苦难年代III", 70, "：在药枚、筑墙、活木甲不生效的情况下干员不主动撤退或被击倒无漏完成战斗"));
	}
